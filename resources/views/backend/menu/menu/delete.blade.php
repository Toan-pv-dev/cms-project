...
<form action="{{ route('menu.destroy', $menuCatalogue->id) }}" class="box" method="post">
    @csrf
                    ...
                    <div class="ibox-content">
                        <div class="row ">
                            <div class="col-lg-6 mb10">
                                <div class="form-row">
                                    <label class="control-label text-left" for="">Tên Menu</label>
                                    <span class="text-danger">(*)</span>
                                    <input type="text" name="name"
                                        value="{{ old('name', $menuCatalogue->name ?? '') }}" class="form-control"
