            ...
            <div class="col-lg-9">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        @include('backend.gallery.catalogue.components.general')
                    </div>
                </div>
                @include('backend.dashboard.components.album')
                @include('backend.gallery.catalogue.components.seo')
            </div>

            <div class="col-lg-3">
                @include('backend.gallery.catalogue.components.aside')
            </div>
        </div>
