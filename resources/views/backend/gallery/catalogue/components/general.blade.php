<div class="row mb15">
    <div class="col-lg-12">
        <div class="form-row">
            ...
            <input type="text" name="name" value="{{ old('name', $galleryCatalogue->name ?? '') }}" class="form-control"
    ...
    <div class="col-lg-12">
        <div class="form-row">
            ...
            <textarea type="text" name="description" class="form-control ck-editor" placeholder="" autocomplete="off"
                id="description" data-height="500">{{ old('description', isset($galleryCatalogue->description) ? $galleryCatalogue->description : '') }}</textarea>
        </div>
    </div>
</div>
<div class="row mb15">
    <div class="col-lg-12">
        <div class="form-row">
            ...
            <textarea type="text" name="content" class="form-control ck-editor" placeholder="" autocomplete="off" id="content"
                data-height="500">{{ old('content', $galleryCatalogue->content ?? '') }}</textarea>
        </div>
