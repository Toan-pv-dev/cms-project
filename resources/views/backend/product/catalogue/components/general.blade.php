<div class="row mb15">
    <div class="col-lg-12">
        <div class="form-row">
            ...
            <input type="text" name="name" value="{{ old('name', $productCatalogue->name ?? '') }}" class="form-control"
    ...
    <div class="col-lg-12">
        <div class="form-row">
            ...
            <textarea type="text" name="description" class="form-control ck-editor" placeholder="" autocomplete="off"
                id="description" data-height="500">{{ old('description', isset($productCatalogue->description) ? $productCatalogue->description : '') }}</textarea>
        </div>
    </div>
</div>
<div class="row mb15">
    <div class="col-lg-12">
        <div class="form-row">
            ...
            <textarea type="text" name="content" class="form-control ck-editor" placeholder="" autocomplete="off" id="content"
                data-height="500">{{ old('content', $productCatalogue->content ?? '') }}</textarea>
        </div>
