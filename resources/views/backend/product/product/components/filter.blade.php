        ...
        <div class="component-filter d-flex ">
            ...
            <div class="right-component-filter col-lg-6 col-md-3 mb-2 mr-10 p0">
                <div class=" perpage-select col-lg-3 col-md-4">
                    <select name="product_catalogue_id" class="form-control setupSelect2 publish">
                ...
                <div class=" filter-add-component  ">
                    <a href="{{ route('product.create') }}"><button type="button" class="btn btn-warning w-100">
                            <i style="margin-right: 6px"
                                class="glyphicon glyphicon-plus"></i>{{ $config['seo']['create_index'] }}</button></a>
                </div>
            </div>
        </div>
    </div>
