                        ...
                        @foreach ($dropdown as $key => $item)
                            @if ($key != old('product_catalogue_id', $product->product_catalogue_id ?? ''))
                                ...
                                <option @if (is_array(old(
                                            'product_catalogue',
                                            isset($product_catalogue) && count($product_catalogue) ? $product_catalogue : [])) && in_array($key, old('product_catalogue', isset($product_catalogue) ? $product_catalogue : []))) selected @endif value="{{ $key }}">
                                    {{ $item }}
                                </option>
                            @endif
