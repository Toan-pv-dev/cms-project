    ...
    <div class="filter-wrapper">
        ...
        <div class="component-filter d-flex ">
            ...
            <div class="filter-add-component ">
                <a href="{{ route('permission.create') }}"><button type="button" class="btn btn-warning w-100">
                        <i style="margin-right: 6px" class="glyphicon glyphicon-plus"></i>Thêm mới quyền</button></a>
            </div>
        </div>
    </div>
</form>
