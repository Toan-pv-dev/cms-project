            ...
            @foreach ($attributeCatalogues as $attributeCatalogue)
                <tr>
                    ...
                    <td style="width: 100px; height: 60px; text-align: center;">
                        <span><img style=" width: 100%;height: 100%;object-fit: cover; " src="{{ $attributeCatalogue->image }}"
                                alt=""></span>
                    </td>
                    ...
                    <td class="text-center js-switch-{{ $attributeCatalogue->id }}">
                        ...
                        <input type="checkbox" data-field="publish" data-model="{{ $config['model'] }}"
                            ...
                            value="{{ $attributeCatalogue->publish }}" data-modelId="{{ $attributeCatalogue->id ?? '' }}" />

                    </td>
                    <td class="edit-btn-group" style="text-align:center; position: relative">
                        <div class="" style="position: relative, display: inline-block">
                            <a class="btn btn-success" href="{{ route('attribute.catalogue.edit', $attributeCatalogue->id) }}"><i
                                    class="fa fa-edit"></i></a>
                            <a class="btn btn-warning" href="{{ route('attribute.catalogue.delete', $attributeCatalogue->id) }}"><i
