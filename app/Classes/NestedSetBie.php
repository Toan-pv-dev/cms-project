...
/*
    thư viên NestedsetBie để cung cấp thiết kế để xử lý  theo dạng phân cấp trong CSDL
    như giữa cha và con vậy . Giúp dễ dàng tìm kiếm hơn .

    như hồi đó học cây nhi phân . duyệt qua để biết lớp cha lớp con dễ dàng hơn .
*/
