...
@endif
@php
    $url = $config['method'] == 'create' ? route('moduleName.store') : route('moduleName.update', $moduleName->id);
@endphp
            ...
            <div class="col-lg-9">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        @include('backend.moduleName.moduleName.components.general')
                    </div>
                </div>
                @include('backend.dashboard.components.album')
                @include('backend.moduleName.moduleName.components.seo')
            </div>

            <div class="col-lg-3">
                @include('backend.moduleName.moduleName.components.aside')
            </div>
        </div>
