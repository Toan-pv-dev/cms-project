<div class="row wrapper border-bottom gray-bg page-heading">
    ...
    <div class="col-lg-12 mg12">
        <div class="ibox float-e-margins">
            ...
            @include('backend.dashboard.components.toolbox', ['model' => 'ModuleCatalogue'])

            <div class="ibox-content">
                @include('backend.moduleName.moduleName.components.filter')
                @include('backend.moduleName.moduleName.components.table')
            </div>
        </div>
    </div>
</div>
