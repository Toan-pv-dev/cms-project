...
@endif
@php
    $url = $config['method'] == 'create' ? route('viewPath.store') : route('viewPath.update', $moduleName->id);
@endphp
            ...
            <div class="col-lg-9">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        @include('backend.viewPath.components.general')
                    </div>
                </div>
                @include('backend.dashboard.components.album')
                @include('backend.viewPath.components.seo')
            </div>

            <div class="col-lg-3">
                @include('backend.viewPath.components.aside')
            </div>
        </div>
